export const M2_GUIDE_ACTIONS = Object.freeze(['drag', 'trace', 'satellite'])
export const M2_GUIDE_ENTER_DELAY_SECONDS = 0.9
export const M2_GUIDE_REPEAT_DELAY_SECONDS = 1.4

const ACTION_SET = new Set(M2_GUIDE_ACTIONS)

function clamp(value, minimum, maximum) {
  return Math.min(Math.max(value, minimum), Math.max(minimum, maximum))
}

export function isM2GuideDismissAction(action) {
